 ...
 export const Delivery =()=> {
  return (
    ...
    <div className='w-full sm:h-[500px] lg:h-[300px] flex justify-center items-center'>
      ...
      <p className='text-sm text-justify ml-5'>Order before 3pm and get your order <span className='ml-8'>the next day as standard</span></p>
       </div>
       </div>
      ...
      <div className= 'w-[260px] h-[130px] flex justify-center items-center flex-col gap-y-3'>
       <div className='w-[50px] h-[50px] rounded-full bg-black flex justify-center invalid:items-center border-stone-400 border-8'>
       <BsThunderbolt className=" text-3xl text-slate-400 pt-2"/>
        </div>

       <div>
      <h1 className='font-bold text-center text-xl mb-2' >Unbeatable price</h1>
      <p className='text-sm text-justify ml-8'></p>For our materials andquality you <span className='ml-1'>won't find better price anywhere</span>
       </div>
       </div>
            {/* Box 3 */}
       ...
       <div className= 'w-[260px] h-[130px] flex justify-center items-center flex-col gap-y-3'>
       <div className='w-[50px] h-[50px] rounded-full bg-black flex justify-center invalid:items-center border-stone-400 border-8'>
       <SiAdguard className='text-3xl text-slate-400 pt-2'/>
        </div>

       <div>
      <h1 className='font-bold text-center text-xl mb-2'>Made by true artisans</h1>
      <p className='text-sm ml-5 '>Handmade crafted goods made with <span className='ml-8'>real passion and craftmanship</span></p>
       </div>
       </div>
      ...
      <div className= 'w-[260px] h-[130px] flex justify-center items-center flex-col gap-y-3'>
       <div className='w-[50px] h-[50px] rounded-full bg-black flex justify-center invalid:items-center border-stone-400 border-8'>
       <PiRecycleThin className='text-4xl text-slate-400 pt-1'/>
        </div>

       <div>
      <h1 className='font-bold text-center text-xl mb-2' >Recycled packaging</h1>
      <p className='text-sm text-justify ml-8'></p>We use 100% recycled packaging to <span className='ml-1'>ensure our footprint is manageable</span>
       </div>
       </div>
